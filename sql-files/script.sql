...
CREATE TABLE COLHEITA(
	id INT AUTO_INCREMENT,
	email varchar(40) NOT NULL default '',
	nRevista INT default 'Não Especificado',
	...
	ano INT default 'Não Especificado',
	volume INT default 'Não Especificado',
	pagIni INT default 'Não Especificado',
	pagEnd INT default 'Não Especificado',
	idEspecie INT default 'Não Especificado',
	...
	melhorGerminacao float default 'Não Especificado',
...
CREATE TABLE CARACTERIZACAO(
	...
	frutosKilo INT default 'Não Especificado',
	pesoMilFrutos float default 'Não Especificado',
	sementesPorFruto INT default 'Não Especificado',
	sementesPorKilo INT default 'Não Especificado',
	pesoMilSementes float default 'Não Especificado',
	...
	pureza float default 'Não Especificado',
	observacoes varchar(1000) default 'Não Especificado',
	fontes varchar(500) default 'Não Especificado',
	PRIMARY KEY(id),
	FOREIGN KEY(idEspecie) REFERENCES ESPECIE(id) ON DELETE CASCADE
